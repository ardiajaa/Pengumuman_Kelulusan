...
<head>
    ...
    <meta name="dcterms.rightsHolder" content="<?= $settings['nama_sekolah'] ?>" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport content=" width=device-width, initial-scale=1.0" />
    <title>Pengumuman Kelulusan <?= $settings['nama_sekolah'] ?> <?= $settings['tahun_kelulusan'] ?></title>
...
<body id="body"
        ...
        <div id="main-route" class="main-route">
            <div id="index" class="index">
                <div id="index-form" class="index-form"
                    ...
                    <form class="index-form-content" action="cek_kelulusan.php" method="POST">
                        <div class="index-form-content-logo" style="margin-bottom: 10px;">
                            <img src="assets/images/<?= $settings['logo'] ?>" class="index-form-content-logo-snmptn"
                                alt="Logo Sekolah" onclick="window.location.reload()" />
                        </div>
                        <h1 class="index-form-content-title" style="margin: 10px 0;">
                            PENGUMUMAN KELULUSAN <span class="tahun"><?= $settings['tahun_kelulusan'] ?></span>
                        </h1>
                        <span class="index-form-content-subtitle" style="margin-bottom: 10px; display: block;">
                            Masukkan NISN untuk melihat status kelulusan
                        </span>

                        <div class="index-form-content-form" style="margin-bottom: 10px;">
                        ...
                        <span class="index-form-content-alert" id="index-form-alert"
                            style="margin-bottom: 10px; display: block;"></span>

                        <div class="index-form-content-footer" style="margin-top: 10px;">
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (diff <= 0) {
                countdown.innerHTML = `
                    <div class="col-span-full bg-green-500 text-white px-6 py 4 rounded-lg font-bold text-lg text-center animate__animated animate__pulse animate__infinite">
